...
public class MotanExtCodec extends AbstractCodec {
    ...
    private byte[] encodeRequest(Channel channel, Request request) throws IOException {
        ...
        RpcDTO.Request.Builder builder = RpcDTO.Request.newBuilder();
        builder.setInterfaceName(request.getInterfaceName());
        builder.setMethodName(request.getMethodName());
        builder.setParamtersDesc(request.getParamtersDesc());
    ...
    private byte[] encodeResponse(Channel channel, Response value) throws IOException {
        ...
        byte[] body = serialization.serialize(value);
