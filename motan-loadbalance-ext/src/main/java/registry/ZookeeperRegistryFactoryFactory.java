...
@SpiMeta(name = "zookeeper-ext")
public class ZookeeperRegistryFactoryFactory extends AbstractRegistryFactory {
    ...
    protected Registry createRegistry(URL registryUrl) {
        try {
            ...
            return new ZookeeperRegistryExt(registryUrl, zkClient);
        } catch (ZkException e) {
